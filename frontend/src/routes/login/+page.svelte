<script lang="ts">
  ...
  import { authStore, setUser } from '$lib/stores/auth';
  ...
  async function handleLogin() {
    ...
    try {
      const response = await apiClient.login({ email, password }) as { user: any; access_token: string; refresh_token: string };
